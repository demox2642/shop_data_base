...
class LeftoversFragmentAdapterDelegate(

) : AbsListItemAdapterDelegate<CountsProductsInWarehouse, CountsProductsInWarehouse, LeftoversFragmentAdapterDelegate.CountsProductsInWarehouseClassHolder>() {
