...
class ProductCountInSupplyAdapterDelegate (
) : AbsListItemAdapterDelegate<ProductCountInSupply, ProductCountInSupply, ProductCountInSupplyAdapterDelegate.ProductCountInSupplyPlaceHolder>() {
